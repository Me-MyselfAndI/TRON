...
PROGNAME = Tron_The_Legacy

# Here you must put a list of all of the object files
# that will be compiled into your program. For example
# if you have main.c and myLib.c then in the following
# line you would put main.o and myLib.o
OFILES = gba.o font.o main.o images/start_image.o images/blue_cycle.o images/orange_cycle.o images/blue_wins.o images/red_wins.o images/red_h_trace.o images/red_v_trace.o images/red_tl_trace.o images/red_tr_trace.o images/red_br_trace.o images/red_bl_trace.o images/blue_h_trace.o images/blue_v_trace.o images/blue_tl_trace.o images/blue_tr_trace.o images/blue_br_trace.o images/blue_bl_trace.o
